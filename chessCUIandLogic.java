...
public class Chess {
    ...
    private void play(boolean black){
        ...
        if(blackKing==false||blackAlive==0){
            System.out.println("White side wins");
            return;
        }
        else if(whiteKing==false||whiteAlive==0){
            System.out.println("Black side wins ");
            return;
        }
        else if(pieces[row][column].black!=black){
